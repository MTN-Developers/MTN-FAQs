			...
			<div className='flex items-center gap-16 lg:gap-[88px]'>
				<div className='flex gap-3 items-center justify-center cursor-pointer'>
					<Image
						...
						height={24}
					/>
					<span className='hidden md:block text-black  text-lg font-medium leading-5 tracking-[0.21px]'>Company</span>
				</div>
				<div className='flex gap-3 items-center justify-center cursor-pointer'>
					<Image
						src={Youtube}
						...
						height={24}
					/>
					<span className='hidden md:block text-black  text-lg font-medium leading-5 tracking-[0.21px]'>Youtube</span>
				</div>
				<div className='flex gap-3 items-center justify-center cursor-pointer'>
					<Image
						src={X}
						alt='X'
					/>
					<span className='hidden md:block text-black  text-lg font-medium leading-5 tracking-[0.21px]'>X</span>
				</div>
				<div className='flex items-center gap-3 cursor-pointer'>
					<Image
						...
						alt='Facebook'
					/>
					<span className='hidden md:block text-black  text-lg font-medium leading-5 tracking-[0.21px]'>Facebook</span>
				</div>
			</div>
			<p className='text-black text-center mt-4 text-sm font-medium leading-[25px] tracking-[-0.14px] opacity-70'>
				© 2024 All Rights Reserved - Manage The Now
			</p>
		</div>
	);
};
