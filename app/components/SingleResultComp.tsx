...
const SingleResultComp: React.FC<SingleResultCompProps> = ({ faq }) => {
  ...
  return (
    ...
    >
      <h1 className="md:mb-[56px] text-black text-right font-pnu text-[20px] md:text-[40px] font-bold leading-[48px]">
        {title}
      </h1>

      <div className="border-b">
        <h2 className="text-[#00204C] text-right font-pnu text-xl font-bold leading-7">
          - الأعراض:
        </h2>
