	...
	return (
		...
		>
			...
			<div className='border-b'>
				<h2 className='text-[#00204C] text-right font-pnu text-2xl font-bold leading-7'>- الأعراض:</h2>

				<p className='md:pb-[40px] text-gray-600 text-right font-pnu text-lg font-normal leading-[30px]'>{question}</p>
			</div>
			<div className='md:mt-[56px]'>
				<h2 className='text-[#00204C] text-right font-pnu text-2xl font-bold leading-7'>- المشاعر المضطربة:</h2>

				<div className='md:pb-[40px] text-gray-600 text-right font-pnu text-lg font-normal leading-[30px]'>
